...
{p(T(lang,
"Dünya Azərbaycanlı Alimlər Birliyinin (DAAB) bu səhifəsi «Çətin mövzu, aydın izah» müsabiqəsinin iştirakçılarına informatika mövzusu seçməkdə kömək edir. Burada təhsil baxımından əhəmiyyətli və praktikada aktual olan mövzular, onların öyrənilməsindəki çətinliklər və aydın izah üçün nümunələr bir araya gətirilir.",
"This page from the World Association of Azerbaijani Scientists (WAAS / DAAB) helps participants in the “Complex Topics, Clear Explanations” competition choose an informatics topic. It brings together topics that matter in education and in practice, the difficulties of learning them, and examples that can support a clear explanation."))}
{p(T(lang,
