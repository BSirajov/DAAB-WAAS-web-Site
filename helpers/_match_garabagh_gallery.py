#!/usr/bin/env python3
"""Match Qarabağ gallery to local forum photos; copy to Garabagh/."""
...
def load_gallery_urls() -> list[str]:
    if not PAGE_CACHE.is_file():
        raise FileNotFoundError("Run _fetch_garabagh_gallery_playwright.py first")
