...
GROUPS: list[tuple[str, str, list[str]]] = [
    ...
    ("complex-topics", "complexTopics", ["complex-topics", "complex-topics-approach"]),
...
COPY = {
    "az": {
        ...
        "blurbs": {
            ...
            "complex-topics": "Çətin mövzuları aydın və sadə izahı",
    ...
    "en": {
        ...
        "blurbs": {
            ...
            "complex-topics": "Making difficult subjects understandable",
