"""Azerbaijani → English phrase map for Forum 2024 impressions page body."""

from __future__ import annotations

# Story subtitles, story-body paragraphs, moral-box text, blockquotes, intro-card copy.
# Shell/nav/footer strings are handled by forum_en_common.apply_shell.
IMPRESSIONS_PHRASES: dict[str, str] = {
    # hero, panel, TOC and card titles
    ...
    # Afina Məmmədli Barmanbay — story-body
    ...
    "Birinci forumun belə yüksək səviyyədə təşkil olunması böyük qürur mənbəyidir. DAAB İdarə Heyətinin sədri Məsud Əfəndiyevin təşkilatçılıq qabiliyyəti və yorulmaz fəaliyyəti xüsusi təqdirə layiqdir. Diasporla İş üzrə Dövlət Komitəsinin əməkdaşlarının və bütün təşkilatçıların əməyi forumun uğurunda mühüm rol oynadı.": (
        "That the first forum was organised at such a high level is a source of great pride. The organisational ability and tireless work of Messoud Efendiyev, Chair of the WAAS Executive Board, deserve special recognition. The efforts of the staff of the State Committee for Work with Diaspora and of all organisers played an important role in the forum's success."
    ),
    ...
    # Afina — additional closing thoughts
    ...
    # moral-box reflections (İbrət nəticəsi paragraphs)
    "Bu forum göstərdi ki, dünyanın müxtəlif ölkələrində yaşayan azərbaycanlı alimləri bir araya gətirən əsas qüvvə yalnız elm deyil, həm də vətən sevgisi, milli həmrəylik və gələcək nəsillərə qarşı məsuliyyət hissidir.": (
        "This forum showed that the main force bringing together Azerbaijani scientists living in various countries is not science alone but also love of the homeland, national solidarity and a sense of responsibility towards future generations."
    ),
    "Elm adamlarının birliyi yalnız bilik mübadiləsi deyil, həm də milli maraqların qorunması və Azərbaycanın beynəlxalq elmi nüfuzunun gücləndirilməsi üçün strateji gücdür.": (
        "The unity of scientists is not only an exchange of knowledge but also a strategic force for protecting national interests and strengthening Azerbaijan's international scientific standing."
    ),
    "Bir xalqın gələcəyini müəyyən edən əsas qüvvə onun elmi potensialı və həmin potensialı ortaq məqsəd uğrunda birləşdirmək bacarığıdır.": (
        "The main force determining a nation's future is its scientific potential and the ability to unite that potential towards a common goal."
    ),
    "Elm yalnız bilik istehsal etmir, həm də insanları, xalqları və gələcəyi bir-birinə bağlayan mənəvi körpü yaradır.": (
        "Science not only produces knowledge but also creates a moral bridge linking people, nations and the future."
    ),
    "Elmin inkişafı fərqli sahələrin və fərqli ölkələrdə yaşayan insanların əməkdaşlığından doğan ortaq düşüncə ilə mümkün olur.": (
        "The advancement of science is possible through shared thinking born of cooperation among different fields and among people living in different countries."
    ),
    "Elm yalnız bugünü izah etmir, həm də gələcəyin təhlükəsiz və dayanıqlı inkişaf yolunu müəyyənləşdirir.": (
        "Science not only explains the present but also charts the path towards a safe and sustainable future."
    ),
    "Bir millətin elmi gücü yalnız fərdi nailiyyətlərlə deyil, ortaq məqsəd uğrunda birləşən alimlərin həmrəyliyi ilə formalaşır.": (
        "A nation's scientific strength is formed not only by individual achievements but by the solidarity of scientists united around a common purpose."
    ),
    "Doğma vətənlə əlaqə insanın daxilində heç vaxt sönməyən mənəvi bağdır və elm bu bağın daha da möhkəmlənməsinə xidmət edə bilər.": (
        "The bond with one's native homeland is a moral tie within a person that never fades, and science can serve to strengthen that bond further."
    ),
    "Tarixini və elmi irsini tanıyan xalq gələcəyini daha inamla qurur.": (
        "A people that knows its history and scientific heritage builds its future with greater confidence."
    ),
    "Elm sərhəd tanımır; dünyanın müxtəlif ölkələrində yaşayan azərbaycanlı alimlərin ortaq fəaliyyəti milli inkişafın güclü dayağına çevrilə bilər.": (
        "Science knows no borders; the joint work of Azerbaijani scientists living in various countries can become a strong pillar of national development."
    ),
    "Elm insanları birləşdirə bilər, amma onları böyük məqsədlər uğrunda hərəkətə gətirən əsas qüvvə vətən sevgisidir.": (
        "Science can unite people, but the main force that moves them towards great goals is love of the homeland."
    ),
    "Bir millətin gücü yalnız onun iqtisadi və hərbi imkanları ilə deyil, həm də dünyanın müxtəlif yerlərində yaşayan ziyalılarının ortaq məqsəd ətrafında birləşə bilməsi ilə ölçülür.": (
        "The strength of a nation is measured not only by its economic and military capabilities but also by the ability of its intellectuals living in different parts of the world to unite around a common purpose."
    ),
}


def apply_impressions_phrases(html: str) -> str:
    import re

    html = re.sub(r"[ \t]{2,}", " ", html)
    for az, en in sorted(IMPRESSIONS_PHRASES.items(), key=lambda kv: -len(kv[0])):
        key = re.sub(r"[ \t]{2,}", " ", az)
        html = html.replace(key, en)
    return html
