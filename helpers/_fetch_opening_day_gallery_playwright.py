#!/usr/bin/env python3
"""Fetch Açılış günü gallery URLs and thumbnails via Playwright (Google blocks raw HTTP)."""
...
PAGE_URL = (
    ...
    "a%C3%A7%C4%B1l%C4%B1%C5%9F-g%C3%BCn%C3%BC"
)
URL_CACHE = ROOT / "helpers" / "_cache_opening_day_gallery_urls.txt"
