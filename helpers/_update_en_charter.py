...
SECTIONS: list[tuple[str, str, str, list[str]]] = [
    ...
    (
        ...
        [
            ...
            p(
                ...
                "is considered and decided by the Association's executive board within thirty "
            ...
            p(
                ...
                "accepted by the executive board constitute the initial membership of the Association."
            ),
            p(
                "Those who have provided significant material and moral support to the Association "
                "may be accepted as honorary members by decision of the executive board."
            ),
            p(
                ...
                "acceptance and removal procedures are carried out by the branch executive board "
    ...
    (
        ...
        [
            p(
                ...
                "resignation petition reaches the executive board. Resigning from membership "
    ...
    (
        ...
        [
            ...
            p(
                ...
                "from membership by decision of the executive board."
            ),
            p(
    ...
    (
        ...
        [
            ...
            p(
                ...
                "place and time determined by the executive board."
            ),
            p(
                "An extraordinary meeting is called by the executive board when deemed "
                "necessary by the executive board or audit board, or upon the written "
                "application of one fifth of the members. If the executive board does not call "
            ...
            p(
                "The executive board prepares the list of members who have the right to attend "
            ...
            p(
                ...
                "members of the executive board and the audit board combined."
            ),
            p(
                ...
                "members of the executive board or by the officers appointed by the executive board. "
            ...
            p(
                ...
                "meeting is opened by the chair of the executive board, or by a member of "
            ...
            p(
                ...
                "a member, the chair of the governing body of the legal entity, or the "
            ...
            p(
                ...
                "delivering them to the newly elected executive board within seven days."
            ),
        ],
    ),
    (
    ...
    (
        ...
        [
            ...
            ol([
                ...
                "Discussing the reports of the executive board and audit board, and acquitting the executive board;",
                "Discussing the budget prepared by the executive board and accepting it as is or with modifications;",
                "Supervising other organs of the Association and, when deemed necessary, dismissing them for reasons;",
                "Considering and deciding on objections raised against decisions of the executive board to refuse membership or expel members;",
                "Authorising the executive board to acquire real estate needed for the Association, or to sell existing real estate;",
                "Examining and approving the regulations to be prepared by the executive board regarding the activities of the Association, either as they are or with amendments;",
                "Determining wages and all types of allowances, daily and travel allowances and compensation to be paid to the chairman and members of the Association's executive board and audit board who are not government officials;",
                "Deciding whether the Association will join or leave a federation;",
                "Deciding to open the branches or departments of the Association and authorising the executive board to carry out the related transactions;",
                ...
                "Considering and adopting decisions on other proposals of the executive board;",
    ...
    (
        ...
        [
            p(
                "The executive board, consisting of five main and five substitute members, is "
                "elected by the General Assembly."
            ),
            p(
                "At its first meeting after the election, the executive board appoints, by "
                "resolution, a chairman, co-chairman, vice-chairman, secretary, treasurer and "
                "member by division of duties."
            ),
            p(
                "In the event of a vacancy in the main composition of the executive board due "
            ...
            p("The executive board fulfils the following tasks:"),
            ol([
                ...
                "Preparing the Association's operating account statements (or balance sheet and income statements), reporting on the activities of the executive board at the end of each calendar year, and presenting these to the General Assembly when it meets;",
    ...
    (
        ...
        [
            ...
            p(
                ...
                "board presents its report to the executive board and to the General Assembly "
                "at its meetings."
            ),
    ...
    (
        ...
        [
            ...
            p(
                ...
                "balance-sheet basis as determined by the executive board."
            ),
            p(
            ...
            ol([
                "Resolution Book: decisions of the executive board are recorded in this book in order by date and number; all decisions are signed by the members present at the meeting.",
    ...
    (
        ...
        [
            ...
            p(
                ...
                "house by decision of the executive board."
            ),
            p(
            ...
            p(
                "With the exception of the main members of the executive board, the person or "
                "persons who will receive income on behalf of the Association are determined by a "
                "resolution of the executive board, which also specifies the term of office. A "
                ...
                "and approved by the chair of the Association's executive board. Main "
                "members of the executive board can receive income without a power of attorney."
            ),
    ...
    (
        ...
        [
            p(
                ...
                "previous year, after approval by the executive board, are recorded in the "
    ...
    (
        ...
        [
            ...
            p(
                ...
                "the results — including the main and alternate members elected to the executive board, the "
    ...
    (
        ...
        [
            p(
                ...
                "the General Assembly, the executive board or independent audit firms does not "
    ...
    (
        ...
        [
            p(
                "The Association may borrow money by decision of the executive board when "
    ...
    (
        ...
        [
            p(
                ...
                "authorised by the executive board of the Association submits the branch "
    ...
    (
        ...
        [
            p(
                ...
                "The executive board is elected by the general assembly of the branch — five "
    ...
    (
        ...
        [
            p(
                ...
                "day, place and time determined by the branch executive board. Branches are "
            ...
            p(
                "Members of the executive board or audit board of a branch leave their "
                "positions in the branch upon election to the executive board or audit board "
                "of the head office."
            ),
        ],
    ),
    (
        ...
        [
            p(
                "The Association may, by decision of the executive board, open representative "
                ...
                "appointed as representatives by decision of the executive board. "
    ...
    (
        ...
        [
            ...
            p(
                "The final members of the executive board are responsible for maintaining "
                "the books and records of the Association as a liquidation committee. This "
                "responsibility may also be assigned to a member of the executive board. "
