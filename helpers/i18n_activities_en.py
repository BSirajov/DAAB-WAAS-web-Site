...
ACTIVITIES_REPLACEMENTS: list[tuple[str, str]] = [
    ...
    (
        ...
        "WAAS Board of Directors sends congratulatory letter on 90th anniversary of Academician Telman Aliyev",
    ),
    (
    ...
    ("DAAB İdarə Heyətinin həmsədri", "WAAS Board of Directors Co-Chair"),
    ("DAAB İdarə Heyətinin sədri", "WAAS Board of Directors Chair"),
    ("DAAB İdarə Heyətinin üzvü", "WAAS Board of Directors member"),
    ("DAAB İdarə Heyətinin üzvləri", "WAAS Board of Directors members"),
    ("İdarə Heyətinin həmsədri", "Board of Directors Co-Chair"),
    ("İdarə Heyətinin sədri", "Board of Directors Chair"),
    ("İdarə Heyətinin üzvü", "Board of Directors member"),
    ("İdarə Heyətinin üzvləri", "Board of Directors members"),
    ("DAAB İH", "WAAS EB"),
    ("Axtarış üçün yazmağa başlayın…", "Start typing to search…"),
