#!/usr/bin/env python3
"""Build az/application.html from az/application/application.html with DAAB site shell."""
...
def extract_nav(html: str) -> str:
    m = re.search(
        r'(<nav aria-label="Əsas naviqasiya" class="nav-strip">.*?</nav>)',
        html,
        re.DOTALL,
    )
...
def extract_form_block(src: str) -> str:
    ...
    block = block.replace(
        'class="progress-bar"',
        'class="app-progress-bar" role="navigation" aria-label="Form addımları"',
    )
    ...
    block = block.replace('<a href="#">Nizamnamə</a>', '<a href="charter.html">Nizamnamə</a>')
...
<html lang="az" data-daab-lang="az" data-daab-asset-root="{ASSET}" data-daab-page-id="membership-application" data-daab-nav-mount="1">
<head>
<meta charset="utf-8"/>
<meta name="viewport" content="width=device-width, initial-scale=1.0, viewport-fit=cover"/>
<title>DAAB — Üzvlük Müraciət Forması</title>
<meta name="description" content="Dünya Azərbaycanlı Alimlər Birliyinə üzvlük üçün onlayn müraciət forması."/>
...
<h2 class="panel-title">Üzvlük müraciəti forması</h2>
<p class="panel-copy">Giriş, şəxsi məlumatlar, elm sahələri və əlavə məlumatlar bölmələrini ardıcıl doldurun. CV və fotoşəkil üçün e-poçt ünvanımız göstərilir.</p>
</div>
</aside>
</div>
</header>
